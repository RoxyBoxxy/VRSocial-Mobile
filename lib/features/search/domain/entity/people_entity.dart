...
class PeopleEntity {
  ...
  factory PeopleEntity.fromPeopleModel(PeopleModel model,bool isCurrentLoggedInUser){
    return PeopleEntity._(
        ...
        buttonText: model.isFollowing?"Unfollow":"Follow",isCurrentLoggedInUser: isCurrentLoggedInUser
    );
  }
  factory PeopleEntity.fromLikesResponse(LikePeopleModel model,bool isCurrentLoggedInUser){
    return PeopleEntity._(id: model.id.toString(),
        profileUrl: model.avatar,
        userName: model.username,
        fullName: model.name,
        isFollowed: model.isFollowing,
  ...
  factory PeopleEntity.getDummyData(){
    return PeopleEntity._(
        id: faker.guid.guid(),
        profileUrl: 'https://picsum.photos/200?random=${Random.secure().nextInt(100)}',
        userName: "@"+faker.person.firstName(),
        fullName: faker.person.name(),
        isFollowed: true,
        isVerified: false, buttonText: "Follow");
  }
