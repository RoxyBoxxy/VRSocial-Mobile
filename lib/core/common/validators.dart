...
//      sink.addError("Req min 1 number");
 ...
 StreamTransformer<String, String> notEmptyValidator(FieldType type) => StreamTransformer<String, String>.fromHandlers(handleData: (string, sink) {
...
final RegExp urlPattern = RegExp(r"(https?|http)://([-A-Z0-9.]+)(/[-A-Z0-9+&@#/%=~_|!:,.;]*)?(\?[A-Z0-9+&@#/%=~_|!:‌​,.;]*)?",caseSensitive: false);
