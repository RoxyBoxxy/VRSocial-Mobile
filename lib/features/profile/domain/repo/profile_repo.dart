...
abstract class ProfileRepo{
  ...
  Future<Either<Failure,List<PostEntity>>> getUserPostByCategory(PostCategoryModel model);

  Future<Either<Failure,List<PostEntity>>> getBookmarks(String offsetId);

  Future<Either<Failure,List<FollowerEntity>>> getFollower(PostCategoryModel model);

  Future<Either<Failure,List<FollowerEntity>>> getFollowing(PostCategoryModel model);
  ...
  Future<Either<Failure,dynamic>> updateUserSetting(UpdateSettingsRequestModel model);
