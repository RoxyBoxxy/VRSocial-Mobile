...
class ReceiverChatItem extends StatelessWidget {
  ...
  const ReceiverChatItem({Key key, this.chatEntity, this.otherUserProfileUrl}) : super(key: key);
              ...
              chatEntity.message
                  ...
                  decoration: const BoxDecoration(
                      ...
                      borderRadius: BorderRadius.only(
                          ...
                          bottomRight: Radius.circular(20)))).toFlexible(),
              5.toSizedBox,
              [chatEntity.time.toCaption()]
                  .toRow(mainAxisAlignment: MainAxisAlignment.end)
            ].toColumn(crossAxisAlignment: CrossAxisAlignment.start).toFlexible()
          else CachedNetworkImage(
            key: ObjectKey(chatEntity),
            placeholder: (c,i)=>const CircularProgressIndicator(),
            imageUrl: chatEntity?.profileUrl == "https://www.colibri-sm.ru/upload/default/avatar.png" ? chatEntity?.message : chatEntity?.profileUrl,
          ).onTapWidget(() {
            showAnimatedDialog (
