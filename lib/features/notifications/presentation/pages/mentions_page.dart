                ...
                child: StreamBuilder<Set<int>>(
                  ...
                  builder: (context, snapshot) {
                    return PagedListView(
                        ...
                        pagingController: _notificationCubit.mentionsPagination.pagingController,
                        ...
                        noItemsFoundIndicatorBuilder: (_) => NoDataFoundScreen(
                          ...
                          message: 'There seems to be no mention of you. All links to you in user publications will be displayed here.',
                          icon: const Icon(FontAwesomeIcons.at,size: 40,color: AppColors.colorPrimary,),
                          onTapButton: () {
                        ...
                        itemBuilder: (_,item,index)=>NotificationItem(
                          ...
                          if(v)_notificationCubit.mentionsPagination.addDeletedItem(index);
                          else _notificationCubit.mentionsPagination.deleteSelectedItem(index);
                        },isSelected: snapshot?.data?.toList()?.contains(index)??false,)
                    ));
                  }
                ),
              );
                  ...
                  child: ListTile(
                    ...
                    context.showOkCancelAlertDialog(desc: "Are you sure you want to delete the selected notifications? Please note that this action cannot be undone!",
                        title: "Please confirm your actions!",okButtonTitle: "Delete",onTapOk: (){
                          ...
                          _notificationCubit.mentionsPagination.deleteNotification();
                        });
