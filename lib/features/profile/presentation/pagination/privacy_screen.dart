  ...
  _generateItem(List<PrivacyWidgetModel> items) {
    return StreamBuilder<SettingEntity>(
      ...
      builder: (context, snapshot) {
        return snapshot.data==null?const SizedBox():SmartSelect.single(
          value: items.firstWhere((element) => element.isSelected)?.value,
          ...
          choiceItems: items
              .map((e) => S2Choice(
                  value: e.value,
                  title: e.value,
                  group: PrivacyWidgetModel.getEnumValue(e.privacyOptionEnum)))
              .toList(),
          onChange: (s) {
            ...
            switch (items[0].privacyOptionEnum) {
              ...
              case PrivacyOptionEnum.PROFILE_VISIBILITY:
                userSettingCubit.changeSettingEntity(settingItem.copyWith(accountPrivacyEntity: settingItem.accountPrivacyEntity.copyWith(canSeeMyPosts: s.value)));
                break;
              case PrivacyOptionEnum.CONTACT_PRIVACY:
                userSettingCubit.changeSettingEntity(settingItem.
                copyWith(accountPrivacyEntity: settingItem.accountPrivacyEntity.copyWith(canFollowMe: s.value)));
                break;
              case PrivacyOptionEnum.SEARCH_VISIBILITY:
                userSettingCubit.changeSettingEntity(settingItem.copyWith(accountPrivacyEntity: settingItem.accountPrivacyEntity.copyWith(showProfileInSearchEngine: s.value)));
                break;
            }
          },
          ...
          tileBuilder: (c, s) => ListTile(
            ...
            subtitle: (s.value as String).toCaption(fontWeight: FontWeight.w600),
