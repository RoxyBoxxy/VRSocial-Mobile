...
@injectable
class GetFollowingUseCase extends UseCase<List<FollowerEntity>,PostCategoryModel>{
  final ProfileRepo profileRepo;

  GetFollowingUseCase(this.profileRepo);
  @override
  Future<Either<Failure, List<FollowerEntity>>> call(PostCategoryModel params) async => profileRepo.getFollowing(params);
