...
class CirclePageIndicatorShow extends StatefulWidget {
  ...
  @override
  CirclePageIndicatorShowState createState() {
    return new CirclePageIndicatorShowState();
  }
}

class CirclePageIndicatorShowState extends State<CirclePageIndicatorShow> {
