      ...
      child: BlocListener<BookmarkCubit,CommonUIState>(
        ...
        listener: (_,state){
          state.maybeWhen(orElse: (){},
              error: (e)=>context.showSnackBar(message: e,isError: true),success: (s)=>context.showSnackBar(message: s,isError: false));
        },
        child: NestedScrollView(headerSliverBuilder: (v,c)=>[
          SliverAppBar(
            elevation: 0.0,
            collapsedHeight: 60,
            expandedHeight: 60,
            ...
            flexibleSpace: "#hashtag, username, etc..."
                .toSearchBarField().toHorizontalPadding(24)
          ...
          child: PostPaginationWidget(
            isComeHome: false,
            isSliverList: false,
            noDataFoundScreen: NoDataFoundScreen(onTapButton: (){
              ...
              icon: const Icon(Icons.menu_book_outlined,color: AppColors.colorPrimary,size: 40,),
