...
SearcPostsResponse searcPostsResponseFromJson(String str) =>
    SearcPostsResponse.fromJson(json.decode(str));

String searcPostsResponseToJson(SearcPostsResponse data) =>
