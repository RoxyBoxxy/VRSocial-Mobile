...
class ThreadedPostItem extends StatefulWidget {
  ...
  const ThreadedPostItem(
      {Key key, this.startingThread = false, this.lastThread = false, this.postEntity})
      : super(key: key);
          ...
          Column(
            ...
            children: [
              ...
              widget.postEntity.profileUrl
                      .toRoundNetworkImage(radius: 13).toFlexible(),
          ...
          [
           ...
           [ const Icon(
            ...
            if(widget.postEntity.media?.isNotEmpty)
              CustomSlider(mediaItems: widget?.postEntity?.media, isOnlySocialLink: false),
              // CustomSlider(mediaItems: widget?.postEntity?.media,),
                              Padding(
                                ...
                                child: widget.postEntity.description
                                 ...
                                 [
                                   [
                                    buildPostButton(AppIcons.commentIcon, widget.postEntity.commentCount).onTapWidget(() {}),
                                    buildPostButton(AppIcons.repostIcon(), widget.postEntity.repostCount),
