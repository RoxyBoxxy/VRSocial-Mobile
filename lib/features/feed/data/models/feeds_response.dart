...
FeedResponse feedResponseFromJson(String str) => FeedResponse.fromJson(json.decode(str));
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    feeds: json["feeds"] == null ? null : List<Feed>.from(json["feeds"].map((x) => Feed.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "feeds": feeds == null ? null : List<dynamic>.from(feeds.map((x) => x.toJson())),
  };
}
...
class Feed {
  ...
  factory Feed.fromJson(Map<String, dynamic> json) => Feed (
    ...
    // ogData: json["og_data"],
    ogData :  json['og_data'] == null || json['og_data'] == "" ? null : json['og_data'],//Class1.fromJson(json['og_data']),
    ...
    media: json["media"] == null ? null : json["media"].isEmpty?[]:List<FeedMedia>.from(json["media"].map((x) => FeedMedia.fromJson(x))),
...
//   String videoEmbed;
//
//   factory OgDataClass1.fromJson(Map<String, dynamic> json) => OgDataClass1(
