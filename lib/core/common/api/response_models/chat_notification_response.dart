...
ChatNotificationResponse chatNotificationResponseFromJson(String str) =>
    ChatNotificationResponse.fromJson(json.decode(str));

String chatNotificationResponseToJson(ChatNotificationResponse data) =>
