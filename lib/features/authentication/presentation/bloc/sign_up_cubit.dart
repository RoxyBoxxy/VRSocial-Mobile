...
class SignUpCubit extends Cubit<CommonUIState> {
  ...
  SignUpCubit(this.signUpUseCase, this.socialLoginUseCase) : super(const CommonUIState.initial()) {
    initCubit();
  }
  ...
  void facebookLogin()async{
    ...
    emit(response.fold((l) => CommonUIState.error(l.errorMessage), (r) => CommonUIState.success(true)));
  }
