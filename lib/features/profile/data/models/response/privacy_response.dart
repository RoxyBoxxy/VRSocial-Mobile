...
class PrivacyModel {
  ...
  factory PrivacyModel.fromJson(Map<String, dynamic> json) => PrivacyModel(
        ...
        contactPrivacy:
            json["contact_privacy"] == null ? null : json["contact_privacy"],
        searchVisibility: json["search_visibility"] == null
            ? null
            : json["search_visibility"],
      );

  Map<String, dynamic> toJson() => {
        "profile_visibility":
            profileVisibility == null ? null : profileVisibility,
