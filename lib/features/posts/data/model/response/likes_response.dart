...
PostLikesResponse postLikesResponseFromJson(String str) =>
    PostLikesResponse.fromJson(json.decode(str));

String postLikesResponseToJson(PostLikesResponse data) =>
...
class PostLikesResponse {
  ...
  factory PostLikesResponse.fromJson(Map<String, dynamic> json) =>
      PostLikesResponse(
        ...
        data: json["data"] == null
            ? null
            : List<LikePeopleModel>.from(
                json["data"].map((x) => LikePeopleModel.fromJson(x))),
      );
